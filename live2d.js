! function(t) {
    ...
    o.prototype = new n.L2DBaseModel, o.prototype.load = function(t, i, e) {
        ...
        var t = UtSystem.getUserTimeMSec() - this.startTimeMSec,
            i = t / 1e3,
            e = 2 * i * Math.PI;
        // gustavo_rubo: remove random motions
        /*
        ...
        */
        // gustavo_rubo: this is the most important line for controlling the expression of the model
        ...
        // This is dependant on the face.js in this directory
        //headTilt
        //console.log(tilt)

        // x angle estimation: (avg_facial_features_x)/(avg_chin_line_x)
        // y angle estimation: (avg_facial_features_y)/(avg_chin_line_y)
        var param_angle_x = 0
        var param_angle_y = 0
        var param_angle_z = 0
        var param_body_angle_x = 0
        var param_eye_ball_x = 0
        var param_eye_ball_y = 0
        var param_mouth_open_y = 0


        if (headTilt != undefined) {
            var param_angle_x = headTilt._x/30
            var param_angle_y = headTilt._y/10
            var param_angle_z = headTilt._z
            var param_mouth_open_y = 1.2 * (headTilt.mouthOpenY - 0.45)
        }
        /*
        if(audioLevel != undefined) {
            const clamp = (num, a, b) => Math.max(Math.min(num, Math.max(a, b)), Math.min(a, b));
            var param_mouth_open_y = clamp((audioLevel - 10)/30, 0, 10)
            //console.log(param_mouth_open_y)
        }*/
        ...
        this.live2DModel.loadParam(),
        	...
        	this.live2DModel.addToParamFloat("PARAM_ANGLE_X", 30 * param_angle_x, 1),
        	this.live2DModel.addToParamFloat("PARAM_ANGLE_Y", 30 * param_angle_y, 1),
        	this.live2DModel.addToParamFloat("PARAM_ANGLE_Z", param_angle_z*10, 1),
        	this.live2DModel.addToParamFloat("PARAM_BODY_ANGLE_X", 5 * param_angle_x, 1),
        	this.live2DModel.addToParamFloat("PARAM_EYE_BALL_X", 10 * param_angle_x, 1),
        	this.live2DModel.addToParamFloat("PARAM_EYE_BALL_Y", 10 * param_angle_y, 1),
        	this.live2DModel.addToParamFloat("PARAM_ANGLE_X", Number(10 * Math.sin(e / 6.5345)), .5),
        	this.live2DModel.addToParamFloat("PARAM_ANGLE_Y", Number(6 * Math.sin(e / 3.5345)), .5),
        	this.live2DModel.addToParamFloat("PARAM_ANGLE_Z", Number(7 * Math.sin(e / 5.5345)), .5),
        	...
        	this.live2DModel.setParamFloat("PARAM_MOUTH_OPEN_Y", param_mouth_open_y),
